    ...
    def run(self):
        if self.currently_selecting == STAGE.Container:
            try:
                ...
                print("Invalid choice, please choose one from Waffle Cone/Sugar cone/Cup")                     
            ...
            try:
                ...
                print("Invalid choice of scoops selected, try again")
            except ExceededRemainingChoicesException:
                print("Sorry! You have exceeded the maximum # of scoops, please enter next to proceed to the next item selection")
            except NeedsCleaningException:
                print("machine to be cleaned before proceeding")
            ...
            try:
                ...
                print("Invaid choice of toppngs selected, try again")
            except ExceededRemainingChoicesException:
                print("Sorry! You Have exceeded the maximum # of toppings, please enter done to proceed to the billing")
            ...
            try:
                ...
                print("please enter the correct payment amount to proceed")
        self.run()
